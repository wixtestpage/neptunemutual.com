...
export const BECOME_CONTRIBUTOR_URL =
  'https://docs.neptunemutual.com/community/apply-to-contribute'
export const COMMUNITY_GUIDELINES_URL =
  'https://docs.neptunemutual.com/community/code-of-conduct'
export const TERMS_OF_SERVICE_URL =
  'https://docs.neptunemutual.com/usage/terms-of-use'
